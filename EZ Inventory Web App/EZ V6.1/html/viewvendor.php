...
<html lang = "en">
   <head>
<title> PHP Script for Vendor Table </title>
...
// Get the VendorID entered by the user in the ID box
$VendorID = $_POST['VendorID'];
$VendorID = stripcslashes($VendorID);
$VendorIDU = htmlspecialchars($VendorID);

//query to select info from Vendor
$query = "SELECT * FROM Vendor WHERE VendorID = '$VendorIDU'";
...
if($n_rows > 0)
  {
   ...
   {
     print "<td> *****ERROR: USER INPUT INVALID VendorID FOR VENDOR TABLE*****.</td> <br />";
   }
