...
int main ()
{
  ...
  do
      ...
      try 
	{
	  ...
	  char toadd; //this is the number the user wants to add to the stack
	  char erased; // this is the number removed from the stack
	  char looked; // this is the number at the top
