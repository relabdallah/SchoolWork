...
void caseOne()
{
  ...
  cout << "5" << endl;
  L.deleteFront(x);
  cout << x << " has been removed from the list." << endl;
  L.deleteFront(x);
  cout << x << " has been removed from the list." << endl;
...
{ 
  ...
  catch(llist::OutOfRange){cerr << "ERROR: Index is out of range." << endl;}
...
void caseThree()
{
  ...
  catch (llist::Underflow){cerr << "ERROR: List is already empty" << endl;}
}   //end of case 3
