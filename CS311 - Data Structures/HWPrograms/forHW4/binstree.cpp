...
void BST::DeleteVertex(elem_t E)
{
  ...
  if((E == Root->Elem) && (Root->Left == NULL) && (Root->Right != NULL)) //child is to the right
  ...
  else if((E == Root->Elem) && (Root->Left != NULL) && (Root->Right == NULL)) //child is to the left
    {
      V = Root->Left;
      delete Root;
      Root = V;
